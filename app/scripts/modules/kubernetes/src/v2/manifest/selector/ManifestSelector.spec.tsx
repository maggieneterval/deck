...
// import { IManifestSelectorProps, ManifestSelector } from 'kubernetes/v2/manifest/selector/ManifestSelector';
...
//       const account = wrapper.find(AccountSelectInput).first();
//       account.props().onChange(createFakeReactSyntheticEvent({ value: 'my-other-account' }));
//       expect(wrapper.props().selector.location).toBeFalsy();
//     });
//   });
//
...
//         .props()
//         .onChange();
//       expect(wrapper.props().selector.kind).toEqual('configMap');
//     });
//
...
//         .props()
//         .onChange();
//       expect(wrapper.props().selector.kind).toBeNull();
//       expect(wrapper.props().selector.kinds).toEqual([]);
//       expect(wrapper.props().selector.manifestName).toBeNull();
//     });
//
...
//       expect(wrapper.props().selector.manifestName).toEqual('configMap');
//     });
//
...
//         .onChange();
//       expect(wrapper.props().selector.kind).toBeNull();
//       expect(wrapper.props().selector.kinds).toBeNull();
//     });
//
...
// });
//
// const component = (selector: any, props: any = {}): ReactWrapper<IManifestSelectorProps> =>
//   mount(<ManifestSelector updateSelector={noop} selector={selector} {...props} /> as any);
